    ...
    <div className={`rounded-lg border p-4 shadow-sm ${inSystem ? 'border-sky-200 bg-sky-50/40' : 'border-slate-200 bg-white'}`}>
      ...
      <div className="mb-4 grid grid-cols-2 gap-4 sm:grid-cols-4">
        ...
        <div className="flex flex-col gap-1 text-xs text-slate-500">
          סה״כ עלות רכישה
          <div className="rounded border border-slate-200 bg-slate-50 px-2 py-1.5 text-sm font-semibold text-slate-800">
      ...
      <div className="mb-4 rounded-md bg-emerald-50 p-3 text-sm">
